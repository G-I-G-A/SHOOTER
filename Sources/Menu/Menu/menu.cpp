...
void Menu::mainMenu() {
    ...
    //buffer.loadFromFile("../TOWERDEF/AssetsFiles/audio/mainTheme.ogg");
...
void Menu::notice() {
    ...
    myfile.open ("../TOWERDEF/AssetsFiles/ExternFiles/scores.txt");
    ...
    Rules.open ("../TOWERDEF/AssetsFiles/ExternFiles/rules.txt");
    ...
    textureNoticeB.loadFromFile("../DEV_2020/Assets/button/exit_menu.png"); // mettre les images dans le bon projet
...
void Menu::fontTtf () {
    ...
    fontTittle.loadFromFile("../TOWERDEF/AssetsFiles/font/Amatic-Bold.ttf");
    font.loadFromFile("../TOWERDEF/AssetsFiles/font/OpenSans-Bold.ttf");
...
void Menu::setMenuSprites() {
    ...
    background.loadFromFile("../TOWERDEF/AssetsFiles/Background/menuBackground.jpg");
    textureExitB.loadFromFile("../DEV_2020/Assets/button/exit_menu.png"); // mettre les images dans le bon projet
    textureRuleB.loadFromFile("../DEV_2020/Assets/button/block_question.png"); // mettre les images dans le bon projet
